...
public class SingleFingerView extends FrameLayout {
    ...
    private void parseAttr(Context context, Bitmap sourceBitmap) {
        ...
        Bitmap pushImageBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.feather_highlight_crop_handle);
        this.mPushImageHeight = pushImageBitmap.getHeight();
        this.mPushImageWidth = pushImageBitmap.getWidth();
        Bitmap deleteImageBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.highlight_delete);
    ...
    private void setViewToAttr(int width , int height) {
    	...
    	LinearLayout.LayoutParams parentLP = (LinearLayout.LayoutParams)parentView.getLayoutParams();
